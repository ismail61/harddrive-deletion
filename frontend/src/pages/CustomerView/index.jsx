      ...
      <div className="calc container pb-5 mt-5">
        <form className="row g-3" onSubmit={handleFormSubmit}>
          ...
          <div className="text-center" style={{ marginTop: '25px' }}>
            <button type="submit" className="btn" style={{ backgroundColor: '#3498db', width: '350px' }} disabled={isLoading}>
              {isLoading ? (
        ...
        <div className="text-center mt-5">
          ...
          <br />
          {
            checkData?.data && (<progress max="100" value={(checkData?.data?.deletedDevices / (checkData?.data?.totalDevices || 1) * 100)} style={{ width: '400px', height: '40px' }}></progress>)
          }
        </div>
      </div>
